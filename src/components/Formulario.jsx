      ...
      <h2 className={"font-black text-3xl text-center"}>Seguimiento Pacientes</h2>
        ...
        <form onSubmit={handleSubmit} action="" className={"bg-white shadow-md rounded-lg py-10 px-5 mb-10"}>
            ...
            <div className={"mb-5"}>
                ...
                <textarea name="sintomas" id="sintomas" cols="30" placeholder={"Describe los síntomas"} rows="10" className={"border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"}  value={sintomas} onChange={ (e) => setSintomas(e.target.value) }/>
            </div>
